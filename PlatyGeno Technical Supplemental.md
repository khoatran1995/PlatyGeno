...
This document outlines the methodological framework used to categorize the 203 biological features identified by PlatyGeno v1.0.4 in the clinical gut metagenomic dataset.
